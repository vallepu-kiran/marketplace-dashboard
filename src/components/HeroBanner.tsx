    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16 relative z-10">
        <div className="flex items-center">
          <div className="w-full pr-4 md:pr-8 max-w-5xl">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 leading-tight text-white">
              Durable Construction: The 3M 6200 half face respirator,<br className="hidden sm:block" />
              <span className="sm:hidden"> </span>ensuring a durable and long-lasting product.
            </h1>
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-medium transition-colors text-base sm:text-lg">
              Buy Now
            </button>
          </div>
        </div>
